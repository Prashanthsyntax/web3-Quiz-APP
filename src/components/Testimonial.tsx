export default function Testimonial() {
    return (
        <div className="flex items-center divide-x divide-gray-300 mb-10">
            ...
            <div className="pl-3">
                ...
                <p className="text-sm text-gray-500">Trusted by <span className="font-medium text-gray-200">100,000+</span> users</p>
            </div>
        </div>
    );
};